...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
            {"enable_ml_cardest", PGC_USERSET, UNGROUPED,
    ...
    {
            {"enable_ml_joinest", PGC_USERSET, UNGROUPED,
             gettext_noop("Enable ML-based Cardinality Estimation."),
             NULL
            },
            &enable_ml_joinest,
...
static struct config_int ConfigureNamesInt[] =
{
	...
	{
            {"ml_port", PGC_USERSET, UNGROUPED,
             gettext_noop("Sets the port of learned cardinality estimation."),
             NULL
            },
            &ml_port,
            8888, 1, 65535,
...
static struct config_string ConfigureNamesString[] =
{
	...
	{
            {"host", PGC_USERSET, UNGROUPED,
                    gettext_noop("Sets the host of learned cardnality estimation."),
                    NULL,
                    GUC_IS_NAME
            },
            &host,
	...
	{
            {"page", PGC_USERSET, UNGROUPED,
                    gettext_noop("Sets the page of learned cardnality estimation."),
                    NULL,
                    GUC_IS_NAME
            },
            &page,
